...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rlpython-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13726&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rlpython-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rlpython` can be installed with:

```
conda install rlpython
```

It is possible to list all of the versions of `rlpython` available on your platform with:
